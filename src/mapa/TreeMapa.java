...
public class TreeMapa<K extends Comparable<K>, V> extends MapaAbstrata<K, V> implements Serializable {

	private ArvoreAVL<ChaveValor<K, V>> mapa;

	public TreeMapa() {
		mapa = new ArvoreAVL<ChaveValor<K, V>>();
	}
