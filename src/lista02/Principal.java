...
public class Principal {
	...
	static ObjectFile arqListas = new ObjectFile("lista02.dat");
	...
	public static void main(String[] args) {
		...
		while (menu != 4) {
			...
			Keyboard.waitEnter();
			Keyboard.clrscr();
			menu = Keyboard.menu("Manutenção de Alunos/Manutenção de Disciplinas/Matrícula/Terminar");
		}
	...
	public static void manuAlunos(Escola escola) {
		int submenu = Keyboard.menu("Incluir Aluno/Excluir Aluno/Listar Alunos/Retornar");
		Keyboard.clrscr();
		while (submenu != 4) {
			switch (submenu) {
			case 1:
			...
			case 2:
				try {
					escola.removeAluno(new Aluno(Keyboard.readInt("Informe a matricula do aluno: ")));
	...
	public static void matricula(Escola escola) {
		int submenu = Keyboard
				.menu("Matricular Aluno/Listar disciplinas matriculadas pelo aluno/Listar alunos matriculados em uma disciplina/Remover matricula de Aluno em disciplina/Retornar");
		Keyboard.clrscr();
		...
		while (submenu != 5) {
			...
			case 1:
				...
				try {
					escola.matricularAlunoDisc(codAluno, new Disciplina(codDisc));
			...
			case 3:
				...
				try {
					...
					listarAlunosDaDisciplina(disc, escola.listaAlunosMatriculadosDisciplina(disc));
				} catch (Exception e) {
					System.out.println(e.getMessage());
				}
				break;
			...
			case 4:
				...
				codDisc = Keyboard.readInt("Informe o codigo da disciplina: ");
				try{
				escola.removeMatriculaDisciplina(codAluno, escola.getDisciplina(new Disciplina(codDisc)));
				}catch (Exception e){
					System.out.println(e.getMessage());
				}
				break;
			...
			Keyboard.waitEnter();
			Keyboard.clrscr();
			submenu = Keyboard.menu("Matricular Aluno/Listar disciplinas matriculadas pelo aluno/Listar alunos matriculados em uma disciplina/Remover matricula de Aluno em disciplina/Retornar");
		}
	}
	...
	public static void listarAlunosDaDisciplina(Disciplina disciplina,	Aluno[] alunos) {
