...
public class Escola implements Serializable {
	...
	private HashMapa<Aluno, ArvoreBusca<Turma>> mapAlunos;
	private ArvoreBusca<Turma> turmas;
	public ArvoreBusca<Disciplina> disciplinas;
	

	public Escola() {
		mapAlunos = new HashMapa<Aluno, ArvoreBusca<Turma>>();
		turmas = new ArvoreBusca<Turma>();
		disciplinas = new ArvoreBusca<Disciplina>();
	}
	
	public void addAluno(Aluno aluno) throws Exception {
		if (mapAlunos.contains(aluno))
			throw new Exception("Aluno ja matriculado.");
		mapAlunos.put(aluno, new ArvoreBusca<Turma>());
	}
	
	public void removeAluno(Aluno aluno) throws Exception {
		
		ArvoreBusca<Turma> turmas = mapAlunos.getValor(aluno);
	...
	private Turma removerTurma(ArvoreBusca<Turma> lista ,Turma turma) throws Exception {		
	...
	private boolean turmaComAlunos(Turma turma) {
		MyIteratorMapa<Aluno, ArvoreBusca<Turma>> it = mapAlunos.iterator();
		ChaveValor<Aluno, ArvoreBusca<Turma>> temp = it.getFirst();
		ArvoreBusca<Turma> turmasTemp;
	...
	public void matricularAlunoTurma(int matriculaAluno, Turma turma)throws Exception {
		...
		ArvoreBusca<Turma> lista = mapAlunos.getValor(new Aluno(matriculaAluno));
		if (lista != null) {
	...
	public Turma[] listaTurmasDoAluno(Aluno aluno) throws Exception {
		ArvoreBusca<Turma> turmaAluno = mapAlunos.getValor(aluno);
	...
	public Aluno[] listaAlunosMatriculadosTurma(Turma turma) throws Exception {
		ArvoreBusca<Aluno> alunos = new ArvoreBusca<Aluno>();
	...
	private Disciplina removerDisciplina(ArvoreBusca<Disciplina> lista , Disciplina disc) throws Exception {		
